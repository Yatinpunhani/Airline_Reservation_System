...
const char l_destination[5][20]={"DELHI","PUNE","INDORE","CHENNAI","GWALIOR"};	//local Destination
const char i_destination[11][20]={"LONDON","BERLIN","DUBAI","QATAR","BEIJING","PARIS","CANBERRA","TOKYO","WASHINGTON","DELHI","MALDIVES" }; //International Destination
		...
		bool idest(string pass)
	{
		...
		void Registration()
		{
			...
			if(k==49)
			{
				...
				"Ticket: HF"<<tkt<<endl<<"Name: "<<firstname<<" "<<lastname<<endl
				<<"Phone: "<<Address<<endl
				<<"Address: "<<phone<<endl
				...
				tempfile<<"|TICKET INFORMATION:"<<endl<<endl
			...
			else if(k==50)
			{
				...
				outfile.open("flight.txt",ios::app);
				outfile<<"|TICKET INFORMATION:"<<endl<<endl
				<<endl<<"Ticket: HF"<<tkt<<"Name: "<<firstname<<" "<<lastname<<endl
				<<"Phone: "<<Address<<endl
				<<"Address: "<<phone<<endl
				<<"Passport Number: "<<passport<<endl
				<<"Origin: "<<origin
...
int main()
{
    cout<<"\n\n\n\n\n\n\n\t\t\t************************************************************************************************************";
    cout<<"*"<<endl;
    cout<<"\t\t\t*\t--> This program is designed by students of ITM GOI under the guidance of Mr.DD Shrivastava\n";
    cout<<"\t\t\t*\t--> This Project is Airline reservation system which performs various operations which a\n";
    cout<<"\t\t\t*\t--> customer has to do while performing a reservation.\n";
    cout<<"\t\t\t*\t--> This Program uses the concept of OOPS and is built in C++ using file handling\n";
    cout<<"\t\t\t*\t-->Name of the students are:\n";
    cout<<"\t\t\t*\t\t--> Yatin Punhani\n";
    cout<<"\t\t\t*\t\t--> Vishal chaurasi\n";
    cout<<"\t\t\t*\t\t--> Yash Johari\n";
    cout<<"\t\t\t*\t\t--> Priya Jain\n";
    cout<<"\t\t\t*************************************************************************************************************";
    cout<<endl;
	...
	<<endl<<"\t\t\t\t\t\t\t\t\tPress 6 for ADMIN SECTION\n";
		...
		case 49:
			...
			case 54:
				...
				string password="Admin123";
					...
					if(pass==password){
				system("cls");	
				cout<<"Displaying complaints"<<endl;
				cout<<endl;
				cout<<endl;
                     ...
                     ifstream MyReadFile("complain.txt");
